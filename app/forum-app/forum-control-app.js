...
class ForumControlApp {
    ...
    renderForumControl() {
        // 获取当前设置
        const currentSettings = window.forumManager ? window.forumManager.currentSettings : {
            selectedStyle: '贴吧老哥',
            threshold: 5,
            autoUpdate: true
        };
                ...
                <div class="control-section">
                    ...
                    <div class="form-group">
                        ...
                        <select id="forum-style-select" class="form-select">
                            <option value="贴吧老哥" ${currentSettings.selectedStyle === '贴吧老哥' ? 'selected' : ''}>贴吧老哥</option>
                            <option value="知乎精英" ${currentSettings.selectedStyle === '知乎精英' ? 'selected' : ''}>知乎精英</option>
                            <option value="小红书种草" ${currentSettings.selectedStyle === '小红书种草' ? 'selected' : ''}>小红书种草</option>
                            <option value="抖音达人" ${currentSettings.selectedStyle === '抖音达人' ? 'selected' : ''}>抖音达人</option>
                            <option value="B站UP主" ${currentSettings.selectedStyle === 'B站UP主' ? 'selected' : ''}>B站UP主</option>
                            <option value="海角老司机" ${currentSettings.selectedStyle === '海角老司机' ? 'selected' : ''}>海角老司机</option>
                            <option value="八卦小报记者" ${currentSettings.selectedStyle === '八卦小报记者' ? 'selected' : ''}>八卦小报记者</option>
                            <option value="天涯老涯友" ${currentSettings.selectedStyle === '天涯老涯友' ? 'selected' : ''}>天涯老涯友</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="forum-threshold" class="form-input" value="${currentSettings.threshold}" min="1" max="100" placeholder="触发论坛生成的消息数量">
                        <div class="form-hint">当新消息数量达到此值时自动生成论坛内容</div>
                    </div>

                    <div class="form-group">
                        <label class="form-checkbox">
                            <input type="checkbox" id="forum-auto-update" ${currentSettings.autoUpdate ? 'checked' : ''}>
